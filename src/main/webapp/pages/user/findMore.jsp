                ...
                <div class="col-md-8">
                    ...
                    <div class="card mb-4">
                        <c:if test="${ not empty message.imgpath }">
                            <img class="card-img-top" src="${pageContext.request.contextPath}/img/${message.imgpath}" style="height: 400px;width: 600px">
                        </c:if>
        ...
        <div class="box box-primary">
            ...
            <div class="box-footer">
                ...
                <div class="box-tools pull-right">
                    <ul class="pagination">
                        <li><a href="${pageContext.request.contextPath}/userFindByClassMess.do?classmess=1&page=1&size=${pageInfo.pageSize}" aria-label="Previous">首页</a></li>
                        <li><a href="${pageContext.request.contextPath}/userFindByClassMess.do?classmess=1&page=${pageInfo.pageNum-1}&size=${pageInfo.pageSize}">上一页</a></li>
                        <c:forEach begin="1" end="${pageInfo.pages}" var="pageNum">
                            <li><a href="${pageContext.request.contextPath}/userFindByClassMess.do?classmess=1&page=${pageNum}&size=${pageInfo.pageSize}">${pageNum}</a></li>
                        </c:forEach>
                        <li><a href="${pageContext.request.contextPath}/userFindByClassMess.do?classmess=1&page=${pageInfo.pageNum+1}&size=${pageInfo.pageSize}">下一页</a></li>
                        <li><a href="${pageContext.request.contextPath}/userFindByClassMess.do?classmess=1&page=${pageInfo.pages}&size=${pageInfo.pageSize}" aria-label="Next">尾页</a></li>
                    </ul>
                </div>
...
<script>
    ...
    function changePageSize(){
        ...
        location.href = "${pageContext.request.contextPath}/userFindByClassMess.do?classmess=1&page=1&size="+pageSize;
