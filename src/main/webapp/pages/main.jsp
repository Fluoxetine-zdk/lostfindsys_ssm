    ...
    <div class="container-fluid" style="margin-right: 100px;margin-left: 100px">
        ...
        <div class="row" style="background-color: white">
            <div class="col-lg-5" style="margin-left: 60px;margin-right: 30px">
                <h3 class="card-header"><p class="text-center">失物信息列表</p></h3>
                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered ">
                            ...
                            <c:forEach items="${someLostMess}" var="message">
                                <tr>
                                    <td><a href="${pageContext.request.contextPath}/findByMessId.do?id=${message.id}">${message.description}</a></td>
                ...
                <div class="row">
                    <div class="card-footer col-lg-4 col-lg-offset-4">
                        <a style="" href="${pageContext.request.contextPath}/findByClassMess.do?classmess=0&page=1&size=10" >查看更多</a>
                    </div>
                </div>
            </div>

            <div class="col-lg-5" style="margin-left: 30px;margin-right: 30px">
                <h3 class="card-header"><p class="text-center">招领信息列表</p></h3>
                ...
                <div class="row">
                    <div class="card-footer col-lg-4 col-lg-offset-4">
                        <a style="" href="${pageContext.request.contextPath}/findByClassMess.do?classmess=1&page=1&size=10" >查看更多</a>
                    </div>
                </div>
            </div>
        </div>
