...
<meta
	...
	<script>
		function deleteMess(id,msgid) {
			//安全提示
			if (confirm("您确定要删除该条信息吗？")){
				location.href = "${pageContext.request.contextPath}/backstage/deleteLeaveMess.do?id="+id+"&msgid="+msgid;
			}
		}
	</script>
...
<body class="hold-transition skin-purple sidebar-mini">
								...
								<div class="form-group form-inline">
									<div class="btn-group">
										...
										<button type="button" class="btn btn-default" title="刷新"
												onclick="location.href='${pageContext.request.contextPath}/backstage/message/findAllLeaveMess.do?id=${msgid}&page=1&size=5'">
								...
								<tbody>
									...
									<c:forEach items="${pageInfo.list}" var="leavemessage">
										...
										<tr>
											...
											<td>${leavemessage.username}</td>
											<td>${leavemessage.leavemessage}</td>
											<td>${leavemessage.leavetime}</td>
											<td class="text-center">
												<a onclick="deleteMess('${leavemessage.id}','${leavemessage.msgid}')" class="btn bg-olive btn-xs">删除</a>
											</td>
										</tr>
									</c:forEach>
								</tbody>
					...
					<div class="box-footer">
						<div class="pull-left">
							<div class="form-group form-inline">
								...
								<select class="form-control" id="changePageSize" onchange="changePageSize('${msgid}')">
	...
	<script>
		function changePageSize(){
			...
			var msgid = $("#msgid").val()
;			location.href = "${pageContext.request.contextPath}/backstage/message/findAllLeaveMess.do?id="+msgid+"&page=1&size="+pageSize;
